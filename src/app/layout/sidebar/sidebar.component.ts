...
export class SidebarComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.afs.collection("settings").doc('general').get().subscribe((doc) => {
            if (doc.exists) {
                this.GeneralData = doc.data();
                this.bigLogo = this.GeneralData.backoffice_big_logo;
                this.smallLogo = this.GeneralData.backoffice_small_logo;
